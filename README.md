...
> **Workout Tracker** est une application web moderne permettant de **suivre, analyser et visualiser ses séances de musculation**, avec stockage cloud sécurisé et tableaux de bord interactifs.
...
- 🔢 **Fréquence moyenne d’entraînement**
  - personnalisable par période (date début / date fin)
  - calcul :  
    ```
